...
public class Download extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        //ftps = (FTPSClient) Global.global_ftps;
        ...
        tv.setText("Are you sure want to download "+ fname + "?");
    ...
    private void downloadFiles(){
        ...
        if (!isDir){
            ...
            tv.setText("Download file: "+fname);
                ...
                if (!isDir){
                    ...
                    try {
                        ...
                        if (ftps.retrieveFile(f,out) == false){
                            System.err.println("Error downloading file");
                            out.close();
                            Intent i = new Intent(getApplicationContext(), File.class);
                            startActivity(i);
                        }
                        out.close();
                    }
        ...
        textView3.setText("Downloading Finish");
